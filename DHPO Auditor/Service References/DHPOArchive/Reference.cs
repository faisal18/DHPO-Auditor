...
namespace DHPO_Auditor.DHPOArchive {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.eClaimLink.ae/", ConfigurationName="DHPOArchive.ClaimsAndAuthorizationsArchiveSoap")]
    public interface ClaimsAndAuthorizationsArchiveSoap {
        ...
        DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse DownloadTransactionFile(DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.eClaimLink.ae/DownloadTransactionFile", ReplyAction="*")]
        System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse> DownloadTransactionFileAsync(DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.eClaimLink.ae/SearchTransactions", ReplyAction="*")]
        DHPO_Auditor.DHPOArchive.SearchTransactionsResponse SearchTransactions(DHPO_Auditor.DHPOArchive.SearchTransactionsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.eClaimLink.ae/SearchTransactions", ReplyAction="*")]
        System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.SearchTransactionsResponse> SearchTransactionsAsync(DHPO_Auditor.DHPOArchive.SearchTransactionsRequest request);
    }
    ...
    public partial class DownloadTransactionFileRequest {
        ...
        public DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequestBody Body;
        
        public DownloadTransactionFileRequest() {
        }
        
        public DownloadTransactionFileRequest(DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class DownloadTransactionFileResponse {
        ...
        public DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponseBody Body;
        
        public DownloadTransactionFileResponse() {
        }
        
        public DownloadTransactionFileResponse(DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SearchTransactionsRequest {
        ...
        public DHPO_Auditor.DHPOArchive.SearchTransactionsRequestBody Body;
        
        public SearchTransactionsRequest() {
        }
        
        public SearchTransactionsRequest(DHPO_Auditor.DHPOArchive.SearchTransactionsRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SearchTransactionsResponse {
        ...
        public DHPO_Auditor.DHPOArchive.SearchTransactionsResponseBody Body;
        
        public SearchTransactionsResponse() {
        }
        
        public SearchTransactionsResponse(DHPO_Auditor.DHPOArchive.SearchTransactionsResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ClaimsAndAuthorizationsArchiveSoapChannel : DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ClaimsAndAuthorizationsArchiveSoapClient : System.ServiceModel.ClientBase<DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap>, DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap {
        ...
        DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap.DownloadTransactionFile(DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest request) {
        ...
        public int DownloadTransactionFile(string login, string pwd, string fileId, out string fileName, out byte[] file, out string errorMessage) {
            DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest inValue = new DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest();
            inValue.Body = new DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequestBody();
            inValue.Body.login = login;
            inValue.Body.pwd = pwd;
            inValue.Body.fileId = fileId;
            DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse retVal = ((DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap)(this)).DownloadTransactionFile(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse> DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap.DownloadTransactionFileAsync(DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest request) {
            return base.Channel.DownloadTransactionFileAsync(request);
        }
        
        public System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.DownloadTransactionFileResponse> DownloadTransactionFileAsync(string login, string pwd, string fileId) {
            DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest inValue = new DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequest();
            inValue.Body = new DHPO_Auditor.DHPOArchive.DownloadTransactionFileRequestBody();
            inValue.Body.login = login;
            inValue.Body.pwd = pwd;
            inValue.Body.fileId = fileId;
            return ((DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap)(this)).DownloadTransactionFileAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DHPO_Auditor.DHPOArchive.SearchTransactionsResponse DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap.SearchTransactions(DHPO_Auditor.DHPOArchive.SearchTransactionsRequest request) {
        ...
        public int SearchTransactions(string login, string pwd, int direction, string callerLicense, string ePartner, int transactionID, int TransactionStatus, string transactionFileName, string transactionFromDate, string transactionToDate, int minRecordCount, int maxRecordCount, out string foundTransactions, out string errorMessage) {
            DHPO_Auditor.DHPOArchive.SearchTransactionsRequest inValue = new DHPO_Auditor.DHPOArchive.SearchTransactionsRequest();
            inValue.Body = new DHPO_Auditor.DHPOArchive.SearchTransactionsRequestBody();
            inValue.Body.login = login;
            inValue.Body.pwd = pwd;
            ...
            DHPO_Auditor.DHPOArchive.SearchTransactionsResponse retVal = ((DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap)(this)).SearchTransactions(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.SearchTransactionsResponse> DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap.SearchTransactionsAsync(DHPO_Auditor.DHPOArchive.SearchTransactionsRequest request) {
            return base.Channel.SearchTransactionsAsync(request);
        }
        
        public System.Threading.Tasks.Task<DHPO_Auditor.DHPOArchive.SearchTransactionsResponse> SearchTransactionsAsync(string login, string pwd, int direction, string callerLicense, string ePartner, int transactionID, int TransactionStatus, string transactionFileName, string transactionFromDate, string transactionToDate, int minRecordCount, int maxRecordCount) {
            DHPO_Auditor.DHPOArchive.SearchTransactionsRequest inValue = new DHPO_Auditor.DHPOArchive.SearchTransactionsRequest();
            inValue.Body = new DHPO_Auditor.DHPOArchive.SearchTransactionsRequestBody();
            inValue.Body.login = login;
            inValue.Body.pwd = pwd;
            ...
            inValue.Body.minRecordCount = minRecordCount;
            inValue.Body.maxRecordCount = maxRecordCount;
            return ((DHPO_Auditor.DHPOArchive.ClaimsAndAuthorizationsArchiveSoap)(this)).SearchTransactionsAsync(inValue);
        }
    }
}
